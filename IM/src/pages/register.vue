<template>
    <article>
        ...
        <button :class='["btn-login", loginActive ? "btn-login_active" :""]' @click="commit(userId, password)">注册</button>
...
export default defineComponent({
    ...
    setup() {
        ...
        async function commit(userId, password) {
            ...
            let result = await Request.post("/api/user/register", { data: {userId: userId, password}});
            // console.log(result);
